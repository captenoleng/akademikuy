<?php $this->load->view('admin/template/header'); ?>
  ...
  <body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <h1 class="h3 mb-0" style= "color: black; font-weight: bolder; font-size: 18px;">Kelola Guru</h1>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0" style="color: black; font-weight: bold;">Semua Guru</h6>
                            <div class="tambah float-right">
                                <button type="button" style="background: rgba(0,0,0,0); color: black;" type="button" class="btn btn-primary border-0" data-toggle="modal" data-target="#ModalTambahGuru" data-backdrop="false"><i class="fas fa-plus"></i> Tambah</button>
                            </div>
                        </div>
                        <div style="color: black;" class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="tabel_guru" width="100%" cellspacing="0">
                                    <thead>
    ...
    <?php $this->load->view('admin/modal/tambah_guru'); ?>
    <?php $this->load->view('admin/modal/edit_guru'); ?>

    <?php $this->load->view('admin/template/footer'); ?>

    <?php $this->load->view('admin/script/script_guru'); ?>
