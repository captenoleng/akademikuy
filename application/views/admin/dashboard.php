...
<h1 class="h3 mb-0" style= "color: black; font-weight: bolder; font-size: 18px;">Dashboard</h1>
      ...
      <div class="modal fade" id="profile" tabindex="-1" aria-labelledby="profile_title" aria-hidden="true" >
        <div class="modal-dialog">
          ...
          <div class="container-fluid">
            <div class="h-tab ml-2" style= "color: black; font-weight: bolder; font-size: 18px;">Statistik</div><br>
                  ...
                  <div class="card-body">
                    <div class="row no-gutters align-items-center">
                      ...
                      <div class="h5 mb-3 font-weight-bold"
                              style="text-align: center; font-size: 2rem; color: black;"
                        >
                          <?php echo $guru; ?>
                        </div>
                        <div
                          class= "text-xs text-uppercase mb-1 "
                          style="text-align: center; font-size: 22px; color: black;"
                        >
                          guru
                        </div>
                      </div>
