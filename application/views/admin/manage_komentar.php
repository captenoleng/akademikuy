<?php $this->load->view('admin/template/header'); ?>
  ...
  <body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <h1 class="h3 mb-0" style= "color: black; font-weight: bolder; font-size: 18px;">Kelola Komentar</h1>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0" style="color: black; font-weight: bold;">Semua Komentar</h6>
                        </div>
                        <div style="color: black;" class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered" id="tabel_komentar" width="100%" cellspacing="0">
                                    <thead>
    ...
    <?php $this->load->view('admin/script/script_komentar'); ?>
